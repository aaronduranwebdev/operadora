 ...
 */
public class AnhadirContrato extends javax.swing.JDialog {
     ...
     */
    public AnhadirContrato(java.awt.Frame parent, boolean modal, String dni) {
        super(parent, modal);
        initComponents();
        ...
        setTitle("Añadir contrato para el cliente: " + this.dniCliente);
    }
    ...
    private void initComponents() {
        ...
        btnAnhadirLinea = new javax.swing.JButton();
        ...
        btnAnhadirLinea.setText("+");
        btnAnhadirLinea.setEnabled(false);
        btnAnhadirLinea.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAnhadirLineaActionPerformed(evt);
            }
        });
    ...
    private void chkMovilesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkMovilesActionPerformed
        ...
        btnAnhadirLinea.setEnabled(chkMoviles.isSelected());
        btnQuitarLinea.setEnabled(chkMoviles.isSelected());
    }//GEN-LAST:event_chkMovilesActionPerformed

    private void btnAnhadirLineaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnhadirLineaActionPerformed
        DefaultTableModel tabla = (DefaultTableModel) tblLineasMoviles.getModel();
        tabla.addRow(new Object[]{});
    }//GEN-LAST:event_btnAnhadirLineaActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AnhadirContrato.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AnhadirContrato dialog = new AnhadirContrato(new javax.swing.JFrame(), true, dniCliente);
    ...
    private javax.swing.JButton btnAnhadirLinea;
